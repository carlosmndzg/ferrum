...
impl Color {
    ...
    pub(crate) fn default() -> Color {
        Color::wrap_color(0, 0, 0).unwrap()
    }
}

impl Color {
    fn convert_keyword_to_color(keyword: &str) -> Option<Color> {
        match keyword {
    ...
    fn wrap_color(r: u8, g: u8, b: u8) -> Option<Color> {
        Some(Color { r, g, b })
    }
}

impl From<&crate::css::types::Color> for Option<Color> {
